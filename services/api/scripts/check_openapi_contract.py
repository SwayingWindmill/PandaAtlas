...
REQUIRED_ROUTE_METHODS: tuple[tuple[str, str], ...] = (
    ...
    ("/api/v1/releases/current/pandas", "get"),
    ...
    ("/api/v1/me/submissions", "get"),
    ("/api/v1/me/submissions/drafts", "post"),
    ("/api/v1/me/contribution-analytics", "get"),
    ...
    ("/api/v1/me/submissions/{submission_id}/commands/save-draft", "post"),
    ("/api/v1/me/submissions/{submission_id}/commands/submit", "post"),
    (
        "/api/v1/me/submissions/{submission_id}/commands/respond-information-request",
        "post",
    ),
    ("/api/v1/me/submissions/{submission_id}/commands/withdraw", "post"),
    ("/api/v1/me/submissions/{submission_id}/commands/prepare-attachment", "post"),
    ("/api/v1/me/submissions/{submission_id}/attachments/uploads", "post"),
    ("/api/v1/me/attachments/{attachment_id}/complete", "post"),
    ("/api/v1/me/attachments/{attachment_id}/content", "post"),
    ("/api/v1/community-intake/attachments/{attachment_id}/scan", "post"),
    ("/api/v1/community-intake/attachments/{attachment_id}/access", "post"),
    (
        "/api/v1/community-intake/submissions/{submission_id}/contributor-status",
        "post",
    ),
