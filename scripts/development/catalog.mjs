...
const commands = [
  ...
  {
    id: "api.check-serverless-closure",
    category: "verification",
    description: "Validate the Vercel entrypoint, minimal runtime dependencies, and deterministic request closure.",
    command: "python",
    args: ["services/api/scripts/build_serverless_closure.py"],
    requires: ["git", "python"],
    effect: "read-only",
  },
  {
    id: "api.build-serverless-closure",
    category: "build",
    description: "Write the deterministic Vercel FastAPI request-closure artifact.",
    command: "uv",
    args: [
      "run",
      "--directory",
      ...
      "dev",
      "python",
      "scripts/build_serverless_closure.py",
      "--output",
      ".release-gate/api-serverless-closure.json",
    ],
    requires: ["python", "uv"],
    effect: "generated-output",
  },
...
export const DEVELOPMENT_SCOPE_COMMAND_IDS = Object.freeze({
  ...
  api: [
    "api.check-runtime-boundary",
    "api.check-serverless-closure",
    "api.lint",
    "api.test",
  ],
