...
insert into public.media_assets (
  ...
  (
    ...
    'public-media',
    'https://images.zhipanda.example/he-hua-cover.jpg',
    'He Hua portrait',
    'ZhiPanda Editorial',
    'ZhiPanda',
    'editorial-reference',
  ...
  (
    ...
    'public-media',
    'https://images.zhipanda.example/meng-lan-cover.jpg',
    'Meng Lan portrait',
    'ZhiPanda Editorial',
    'ZhiPanda',
    'editorial-reference',
  ...
  (
    ...
    'public-media',
    'https://images.zhipanda.example/bi-li-cover.jpg',
    'Bi Li archive cover',
    'ZhiPanda Editorial',
    'ZhiPanda',
    'editorial-reference',
  ...
  (
    ...
    'public-media',
    'https://images.zhipanda.example/fu-bao-cover.jpg',
    'Fu Bao portrait',
    'ZhiPanda Editorial',
    'ZhiPanda',
    'editorial-reference',
  ...
  (
    ...
    'public-media',
    'https://images.zhipanda.example/yun-chuan-cover.jpg',
    'Yun Chuan portrait',
    'ZhiPanda Editorial',
    'ZhiPanda',
    'editorial-reference',
  ...
  (
    ...
    'public-media',
    'https://images.zhipanda.example/jin-hu-cover.jpg',
    'Jin Hu portrait',
    'ZhiPanda Editorial',
    'ZhiPanda',
    'editorial-reference',
