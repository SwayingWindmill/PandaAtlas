...
export type AtlasSearchParams = Record<string, string | string[] | undefined>;
...
function localizedStatus(value: string, locale: PublicLocale) {
  const t = copy[locale];
...
function localizedSex(value: string, locale: PublicLocale) {
  const t = copy[locale];
...
export function localizedAtlasMetadata(locale: PublicLocale): Metadata {
  const t = copy[locale];
  return {
    title: t.title,
...
export function renderLocalizedAtlasRoute(locale: PublicLocale, rawQuery: AtlasSearchParams) {
