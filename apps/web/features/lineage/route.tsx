...
export type StructuredLineageSearchParams = Record<string, string | string[] | undefined>;
...
export function localizedLineageMetadata(locale: PublicLocale): Metadata {
...
export function renderLocalizedLineageRoute(
  locale: PublicLocale,
  rawQuery: StructuredLineageSearchParams,
) {
