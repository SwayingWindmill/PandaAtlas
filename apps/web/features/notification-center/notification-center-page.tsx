...
const copy = {
  zh: {
    ...
    description: "站内通知、已读状态和邮件偏好仅属于当前账号。关注熊猫不会自动开启邮件。",
    privacy: "此页面不会创建公开用户档案，也不会显示其他关注者。",
    loading: "正在读取通知…",
    ...
    earlier: "查看更早通知",
    preferences: "邮件偏好",
    preferencesBody: "邮件是可选通道。站内 Inbox 与关注关系不会因关闭邮件而删除。",
    enabled: "已开启",
    disabled: "已关闭",
    enable: "开启邮件",
    disable: "关闭邮件",
  ...
  en: {
    ...
    description: "Inbox facts, read state, and email preferences belong only to the current account. Following a panda never enables email automatically.",
    privacy: "This page does not create a public user profile or reveal other followers.",
    ...
    preferencesBody: "Email is optional. Turning it off does not remove Follow or native Inbox facts.",
    enabled: "Enabled",
    disabled: "Disabled",
    enable: "Enable email",
