...
const copy = {
  zh: {
    ...
    description: "这里按发布时间展示你当前收藏熊猫相关的公开资料更新。内容不按热度排序，也不维护已读状态。",
    ...
    emptyBody: "从任意熊猫资料页收藏一只熊猫。之后与这些熊猫相关的公开资料更新会出现在这里。",
    browse: "去找一只熊猫收藏",
    next: "查看更早动态",
  ...
  en: {
    ...
    description: "Updates are shown in publication order for public data changes involving pandas you currently favorite. Nothing is ranked and no viewed-state is maintained.",
    ...
    emptyBody: "Favorite a panda from any profile. Public data updates involving those pandas will appear here.",
