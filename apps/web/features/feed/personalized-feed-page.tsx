...
const copy = {
  zh: {
    eyebrow: "我的熊猫动态",
    title: "看看你关注的熊猫最近发生了什么",
    description: "这里按发布时间展示你当前关注的熊猫、关注前最多 90 天的历史，以及经过审核的全站消息。内容不按热度排序，打开页面也不会自动标记已读。",
    privacy: "此页面仅对你可见。吱熊猫不会建立公开用户主页、关注榜单或社交关系图。",
    ...
    emptyBody: "从任意熊猫资料页关注一只熊猫。之后发布的新动态会出现在这里，并附带最多 90 天、明确标注的较早记录。",
    browse: "去找一只熊猫关注",
    next: "查看更早动态",
  ...
  en: {
    ...
    title: "Updates from the pandas you follow",
    description: "Updates are shown in publication order from pandas you currently follow, plus up to 90 days of earlier history and reviewed site announcements. Nothing is ranked, and opening this page does not mark updates as viewed.",
    privacy: "Only you can see this page. ZhiPanda does not create public member profiles, follower rankings, or social graphs.",
    ...
    emptyBody: "Follow a panda from any profile. New published updates will appear here, together with up to 90 days of clearly labelled earlier history.",
    browse: "Find a panda to follow",
