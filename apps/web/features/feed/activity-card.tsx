...
const copy = {
  zh: {
    ...
    new: "新动态",
    history: "关注前 90 天历史",
    historyBody: "这条动态发生在你关注之前，不计入关注关系归因。",
    deleted: "熊猫档案已不可用",
    published: "发布于",
    occurred: "发生于",
    source: "公开来源",
  ...
  en: {
    ...
    pinned: "Sitewide pin",
    new: "New",
    history: "90-day pre-follow history",
    historyBody: "This Activity predates your Follow and is not attributed to the relationship.",
    deleted: "Panda profile is no longer available",
    published: "Published",
    occurred: "Occurred",
    source: "Public sources",
    sourceCount: (count: number) => `${count} public source${count === 1 ? "" : "s"}`,
    withdrawnBody: "The original Activity is no longer publicly presented. This reason comes from the reviewed retraction record.",
