...
const copy = {
  zh: {
    ...
    localOnlyBody: "更换设备、使用无痕模式或清理浏览器数据后，收藏与最近浏览可能丢失。ZhiPanda 不把这些本地记录发送到分析系统。",
    privacyPoints: [
  ...
  en: {
    ...
    localOnlyBody: "Saved and recent profiles may disappear when you change devices, use private browsing, or clear browser data. ZhiPanda does not send these local records to analytics.",
    privacyPoints: [
