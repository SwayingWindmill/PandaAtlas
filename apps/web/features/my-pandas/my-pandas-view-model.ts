...
const copy = {
  zh: {
    eyebrow: "我的收藏与熊猫生活",
    title: "我的熊猫",
    description: "从这里管理收藏、动态、通知、足迹、游戏记录和熊猫护照。所有账号数据默认保持私有，不会生成公开用户主页或排名。",
    releaseLabel: "熊猫资料来自当前公开版本",
    localOnlyTitle: "护照与最近浏览使用不同存储边界",
    localOnlyBody: "收藏关系和首次收藏历史保存在账号私有护照中；最近浏览只保存在当前浏览器，可随时清除。",
    privacyPoints: [
      "熊猫护照只对当前登录账号可见，并可从收藏关系历史重建。",
      "浏览器最近记录只保存稳定熊猫标识和本地操作时间。",
      "旧的匿名浏览器收藏不会自动并入账号收藏、护照或邮件许可。",
    ],
    passportTitle: "熊猫护照",
    passportDescription: "跨设备同步当前收藏，并保留首次收藏历史。",
    recentTitle: "最近浏览",
    recentDescription: "最多保留最近 12 个熊猫资料，用于恢复探索上下文。",
    loading: "正在读取熊猫护照和本地记录……",
    emptyPassport: "熊猫护照中还没有收藏或贡献记录。请从任意熊猫资料页开始收藏。",
    emptyRecent: "当前浏览器还没有最近浏览记录。打开一个熊猫资料后会在这里出现。",
    browsePandas: "浏览全部熊猫",
    openProfile: "查看熊猫资料",
  ...
  en: {
    eyebrow: "My favorites and panda life",
    title: "My Pandas",
    description: "Manage favorites, activity, notifications, visits, game history, and your Panda Passport here. Account data stays private by default and never creates a public user profile or ranking.",
    ...
    localOnlyBody: "Favorites and first-favorite history stay in your private account Passport; recent visits stay only in this browser and can be cleared at any time.",
    privacyPoints: [
      "Panda Passport is visible only to the signed-in account and can be rebuilt from favorite relationship history.",
      "Local recent history stores only stable profile IDs and local action times.",
      "Legacy anonymous browser saves are never merged automatically into account favorites, Passport, or email consent.",
    ],
    passportTitle: "Panda Passport",
    passportDescription: "Sync current favorites across devices while preserving first-favorite history.",
    ...
    emptyPassport: "Your Panda Passport has no favorite or contribution records yet. Start from any panda profile.",
