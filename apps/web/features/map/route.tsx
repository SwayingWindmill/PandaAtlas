...
export type StructuredMapSearchParams = Record<string, string | string[] | undefined>;
...
export function localizedMapMetadata(locale: PublicLocale): Metadata {
...
export async function renderLocalizedMapRoute(
  locale: PublicLocale,
  rawQuery: StructuredMapSearchParams,
) {
