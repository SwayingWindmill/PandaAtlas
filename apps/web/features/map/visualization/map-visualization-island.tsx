...
const copy = {
  zh: {
    ...
    providerDegraded: "部分地图资源暂时不可用；探索列表仍可完整使用。",
    providerOffline: "当前离线；探索列表仍可完整使用。",
    providerRecovering: "网络已恢复，正在重新请求地图资源。",
    choose: "不用拖动地图也能选择",
    choosePlaceholder: "选择一只熊猫或一个地点",
    select: "查看地图详情",
    zoomIn: "放大",
    zoomOut: "缩小",
    reset: "重置视野",
  ...
  en: {
    regionLabel: "Interactive panda map",
    canvasLabel: "Interactive map canvas",
    providerReady: "Map provider connected",
    providerDegraded: "Some map resources are unavailable; the explore list remains fully usable.",
    providerOffline: "Offline; the explore list remains fully usable.",
    providerRecovering: "Network restored; requesting map resources again.",
    choose: "Choose without dragging the map",
    choosePlaceholder: "Choose a panda or place",
    select: "View map details",
    zoomIn: "Zoom in",
    zoomOut: "Zoom out",
    reset: "Reset view",
    selected: "Map is showing",
    hovered: "Map place",
    scheduler: "Map response p95",
  },
} as const;
