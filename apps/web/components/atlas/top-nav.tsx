      ...
      <div className="flex h-[76px] w-full items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        <div className="flex min-w-0 items-center gap-6 lg:gap-10">
          <Link href="/" className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate pt-1 text-[12px] leading-5 text-[#6D7C6E]">分布地图与保育图谱工作台</p>
            </div>
          </Link>
        ...
        <div className="flex shrink-0 items-center gap-2 md:gap-4">
          ...
          <div className="hidden items-center gap-3 border-l border-[rgba(63,125,72,0.12)] pl-4 lg:flex">
            <Compass className="h-4 w-4 text-[#6D7C6E]" />
            <div className="leading-none">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#6D7C6E]">Current View</p>
          ...
          <div className="hidden items-center gap-2 border-l border-[rgba(63,125,72,0.12)] pl-4 sm:flex">
            ...
            <span className="text-[13px] leading-5 text-[#6D7C6E]">当前数据快照 {formatDateLabel(selectedSnapshotDate)}</span>
          </div>
          ...
          {!isLatest ? (
            ...
            <div className="hidden items-center gap-2 border-l border-[rgba(63,125,72,0.12)] pl-4 md:flex">
              <ShieldCheck className="h-4 w-4 text-[#6D7C6E]" />
              <span className="text-[13px] leading-5 text-[#6D7C6E]">已是最新</span>
            </div>
          )}
        </div>
      </div>
