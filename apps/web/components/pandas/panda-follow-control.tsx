...
const messages = {
  zh: {
    ...
    consentBody: "关注不会自动订阅邮件。你可以单独开启重要动态邮件，也可以只在吱熊猫内查看。",
    consentEnable: "开启重要动态邮件",
    consentSkip: "暂不开启邮件",
    consentEnabled: "已开启重要动态邮件。你的关注状态没有改变。",
  ...
  en: {
    ...
    followed: (name: string) => `You now follow ${name}. This panda is listed in your private Panda Passport.`,
    already: (name: string) => `You already follow ${name}.`,
    cancelled: "Sign-in was cancelled. This panda was not followed.",
    expired: "Sign-in succeeded, but the request expired. Select Follow again.",
    authFailed: "Verification did not complete. This panda was not followed and email was not enabled.",
    sessionExpired: "Your session expired. Verify again to continue following this panda.",
    ...
    consentBody: "Following never subscribes you to email automatically. Enable important update emails separately, or keep updates inside ZhiPanda only.",
    consentEnable: "Enable important update emails",
    consentSkip: "Not now",
    consentEnabled: "Important update emails are enabled. Your follow was not changed.",
    consentFailed: "Email updates could not be enabled. Your follow is unchanged.",
