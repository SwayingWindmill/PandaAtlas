...
const copy = {
  zh: {
    ...
    place: "熊猫生活地点",
    evidence: "地点资料",
    distinctionInstitution: "这是机构资料。熊猫实际生活的物理地点会单独列出，不会把机构名称当作精确居住点。",
    distinctionPlace: "这是物理地点资料。所属机构会单独列出，不会把地点误写成组织。",
    identity: "地点信息与公开范围",
    relatedInstitution: "关联场所",
    relatedPlace: "关联机构",
    current: "现在生活在这里的熊猫",
    historical: "曾经生活在这里的熊猫",
    migrations: "熊猫来到或离开的记录",
    sources: "公开来源",
    revision: "版本与修订",
  ...
  en: {
    institution: "Panda institution",
    place: "Panda place",
    evidence: "Place information",
    distinctionInstitution: "This is an institution profile. Physical places where pandas lived are listed separately; an institution name is never treated as an exact residence.",
    distinctionPlace: "This is a physical place profile. Its institutions are listed separately, and the place is never presented as an organization.",
    identity: "Place information and published scope",
    relatedInstitution: "Associated places",
    relatedPlace: "Associated institutions",
    current: "Pandas living here now",
    historical: "Pandas that lived here before",
    migrations: "Arrivals and departures",
